...
public:
    GameScreen() {
        ...
        CPosition* bposition = new CPosition(0, -53);
        CParticule* bparticule = new CParticule(2);
        ...
        entityManager->addComponent(id, bparticule);
        ...
        //physicSystem->addGenerator(id, new GravityForceGenerator());
        physicSystem->addGenerator(id, new AnchoredSpringForceGenerator(vec3f(0,0,0), 0.2f, 50.f));
